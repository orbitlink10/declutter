<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Update your account details, contact information and location.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex-1">
                ...
                <input id="profile_photo" name="profile_photo" type="file" accept=".jpg,.jpeg,.png,.webp" class="mt-1 block w-full rounded-md border border-slate-300 bg-white text-sm">
        ...
        <div>
            ...
            <textarea id="bio" name="bio" rows="4" class="mt-1 block w-full rounded-md border-slate-300 text-sm shadow-sm focus:border-orange-400 focus:ring-orange-400">{{ old('bio', $user->bio) }}</textarea>
